...
//        table.getColumn("productcode").setMaxWidth(0);
    ...
    private void initComponents() {
        ...
        comboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "NOM fournisseur" }));
        ...
        productCodeLab.setText("Code du produit");
        ...
        productsPanelLayout.setHorizontalGroup(
            ...
            .addGroup(productsPanelLayout.createSequentialGroup()
                .addGroup(productsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(productsPanelLayout.createSequentialGroup()
                        .addComponent(refreshBttn, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(64, 64, 64)
...
int quantity;
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
      int row = table.getSelectedRow();
        ...
        supplierInfoLab.setText("Acheté de "+sup);
...
table.getColumnModel().getColumn(4).setMaxWidth(0);
 ...
 //       loadSearchProductsDatas(text);
    ...
    private void refreshBttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshBttnActionPerformed
        comboBox.removeAllItems();
        comboBox.addItem("Sélectionnez le nom du fournisseur");
        suppliersName();
    ...
    private void addProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addProductMouseClicked
        ...
        if(productCodeTxt.getText().equals("") || dateChooser.getDate()==null || productCodeTxt.getText().equals("")){
            ...
            if("SELECT SUPPLIER'S NAME".equalsIgnoreCase(supplier)){
                JOptionPane.showMessageDialog(null, "Veuillez sélectionner un fournisseur et réessayer!");
            }else{
                ...
                try{
                    ResultSet rs=new ProductDAO().getProduit(productCodeTxt.getText());
                    if(rs.next()){
...
table.getColumnModel().getColumn(4).setMaxWidth(0);
    ...
    private void productCodeTxtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_productCodeTxtKeyReleased
        ...
        try{
            ResultSet rs=new ProductDAO().getProduit(productCodeTxt.getText());
            if(rs.next()){
                productNameLab.setText(rs.getString("Produit"));
    ...
    public void suppliersName(){
        ...
        try{
            while(rs.next()){
                String suppliersName=rs.getString("Marque");
